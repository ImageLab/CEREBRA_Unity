...
namespace ProcessorUnit
{
    class PotatoPrint:IProcessor
    {
        ...
        string[,] IProcessor.GetArgs()
        {
            ...
            arguments[0, 0] = "Esen: ";// arguments[0, 1] = "degrees around x.";//
            arguments[1, 0] = "Irmak: ";// arguments[1, 1] = "degrees around y.";//
